...
massloss=samples$conc.acc.resp.litC, masslossSE=0,
...
\begin{center}
\setkeys{Gin}{width=0.6\textwidth}
<<notlignin, width=7, height=7, echo=F, fig=T, results=hide>>=
par(mfrow=c(2,2), mar=c(4,4,1,1))
timeseries(orig_cTIC$Ph, days, type, pch=pch, main="Phenolic compounds")
cond<-c(F,F,rep(T,72))
timeseries(orig_cTIC$lip[cond], days[cond], type[cond], pch=pch, main="Fatty acids", endsig=T)
timeseries(orig_cTIC$al[cond], days[cond], type[cond], pch=pch, main="Phytol", endsig=T, xlab="incubation(days)")
timeseries(orig_cTIC$Cut[cond], days[cond], type[cond], pch=pch, main="n-alkyl compounds", endsig=T, xlab="incubation(days)")
@
\end{center}
...
corplot(var3, var4, "", "")
par(mar=c(4,5,1,0))
corplot(var1, var5, "", var5lab)
par(mar=c(4,4,1,1))
corplot(var2, var5, "", "")
corplot(var3, var5, "", "")
par(mar=c(4,5,1,0))
corplot(var1, var6, "", var6lab)
par(mar=c(4,4,1,1))
corplot(var2, var6, "", "")
corplot(var3, var6, "", "")
par(mar=c(5,5,0,0))
corplot(var1, var7, var1lab, var7lab)
par(mar=c(5,4,0,1))
corplot(var2, var7, var2lab, "")
par(mar=c(5,4,0,1))
corplot(var3, var7, var3lab, "")
