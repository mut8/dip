...
<<enz, fig=T, echo=F, results=hide>>=
 par(oma=c(2,2,2,2), mfrow=c(2,2), mar=c(0.1,0.1,0.1,0.1))
 timeseries(alldata$Cellulase, alldata$days, alldata$Litter, type="o",
 pch=pch, col=colscale, log="y", endsig=T)
 ...
 col=colscale, log="y", endsig=T)
 timeseries(alldata$Phenoloxidase, alldata$days, alldata$Litter,
 type="o", pch=pch, col=colscale, log="y", endsig=T)
 timeseries(alldata$Phenoloxidase/alldata$Cellulase, alldata$days,alldata$Litter, type="o", pch=pch, col=colscale, log="y", endsig=T)
@
...
<<pca1, fig=T, echo=F, results=hide>>=
 ord.plot(rda(rsim, scale=T), harvest, type,scale=T, col=colscale,
 pch=pch, spe.labels=peaks$origin, spe.mult=2)
...
<<pca2, fig=T, echo=F, results=hide>>=
 ord.plot(rda((rsim-initials.rsim)/initials.rsim, scale=T), harvest, type,scale=T, col=colscale, pch=pch, spe.labels=peaks$origin, spe.mult=3)
@
 \end{center}
 \caption{TEXT}
\label{pca2}
...
<<pca3, fig=T, echo=F, results=hide>>=
 ord.plot(rda((closs.corr.rsim-initials.rsim)/initials.rsim, scale=T), harvest, type,scale=T, col=colscale, pch=pch, spe.labels=peaks$origin, spe.mult=2)
@
 \end{center}
 \caption{TEXT}
 \label{pca3}
...
barp(orig_cTIC$L, days==181, days==0)
#barp(orig_cTIC$Ph, days==181, days==97)
barp(orig_cTIC$C, days==181, days==0)
barp(orig_cTIC$L/orig_cTIC$C, days==181, days==0)

barp(orig_cTIC$L, days==475, days==181)
#barp(orig_cTIC$Ph, days==475, days==181)
barp(orig_cTIC$C, days==475, days==181)
barp(orig_cTIC$L/orig_cTIC$C, days==475, days==181)
...
<<lci, fig=T, echo=F, results=hide, height=5, width=10>>=
par( mfrow=c(1,2), mar=c(4.1,4.1,2.1,.1), tck=0.01)

timeseries(orig_cTIC$L/(orig_cTIC$L+orig_cTIC$C), days, type,
type="o", pch=pch, col=colscale, endsig=T, ylab="Lignin/(Lignin+Carbohydrates)", xlab="Litter incubation (days)")
axis(4, labels=F)
axis(3, labels=F)
...
# masslossSE= samples$masslossSE, 
 yaxt="n", xlab="carbon loss (g CO2-C g-1 litter-C)")
abline(h=100)
axis(2, labels=F)
axis(3, labels=F)
 axis(4)
mtext("LCI (% of initial LCI)", side=4, padj=4)
@

\end{center}
\caption{Development of the LCI (Lignin:(Lignin+Carbohydrates)}
\label{fig:lci}
\end{figure*}
...
<<degr, fig=T, echo=F, results=hide, height=5, width=10>>=
par( mfrow=c(1,3), mar=c(4.1,4.1,2.1,.1), tck=0.01)

timeseries(closs.corr.orig_cTIC$L - initials.orig_cTIC$L, days, type, type="o", pch=pch, col=colscale, endsig=T, ylab="Lignin/(Lignin+Carbohydrates)", xlab="Litter incubation (days)")
axis(4, labels=F)
axis(3, labels=F)

par(mar=c(4.1,.1,2.1,4.1))

timeseries(closs.corr.orig_cTIC$C - initials.orig_cTIC$C, days, type, type="o", pch=pch, col=colscale, endsig=T, ylab="Lignin/(Lignin+Carbohydrates)", xlab="Litter incubation (days)")                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              
                                                                                                                                                                                  abline(h=100)
axis(2, labels=F)
axis(3, labels=F)
 axis(4)
...
<<degr.ratio, fig=T, echo=F, results=hide, height=5, width=10>>=
par( mfrow=c(1,1), mar=c(4.1,4.1,2.1,.1), tck=0.01)

timeseries((closs.corr.orig_cTIC$L - initials.orig_cTIC$L)/(closs.corr.orig_cTIC$C - initials.orig_cTIC$C), days, type, type="o", pch=pch, col=colscale, endsig=T, ylab="Lignin/(Lignin+Carbohydrates)", xlab="Litter incubation (days)")
axis(4, labels=F)
axis(3, labels=F)
...
Unlike data presented by \cite{Klotzbucher2011} we do not find decreasing lignin contents during early litter decomposition or decreasing lignin degradation rates during decomposition. On the other hand do find substancial amounts of litter degraded during the first 6 month. 
