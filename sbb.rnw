...
par(mar=c(4,5,1,0))
corplot(var1, var4, xlab="", ylab=var4lab, pch=pch.h3)
par(mar=c(4,4,1,1))
corplot(var2, var4, xlab="", ylab="", pch=pch.h3)
corplot(var3, var4, xlab="", ylab="", pch=pch.h3)
par(mar=c(4,5,1,0))
corplot(var1, var5, xlab="", ylab=var5lab, pch=pch.h3)
par(mar=c(4,4,1,1))
corplot(var2, var5, xlab="", ylab="", pch=pch.h3)
corplot(var3, var5, xlab="", ylab="", pch=pch.h3)
par(mar=c(4,5,1,0))
corplot(var1, var6, xlab="", ylab=var6lab, pch=pch.h3)
par(mar=c(4,4,1,1))
corplot(var2, var6, xlab="", ylab="", pch=pch.h3)
corplot(var3, var6, xlab="", ylab="", pch=pch.h3)
par(mar=c(5,5,0,0))
corplot(var1, var7, xlab=var1lab, ylab=var7lab, pch=pch.h3)
par(mar=c(5,4,0,1))
corplot(var2, var7, xlab=var2lab, ylab="", pch=pch.h3)
par(mar=c(5,4,0,1))
corplot(var3, var7, xlab=var3lab, ylab="", pch=pch.h3)
...
tab<-xtable(   mighty.corr.matrix, caption="Correlation (R) between Lignin and Carbohydrate degration with litter chemistry, microbial community and decomposition processes. Significant (p<0.05) correlations are printed bold. Data taken from \\cite{Mooshammer2011, Leitner2011, Frank2011}", label="corrtable", align=rep("c",9) )
