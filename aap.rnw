...
timeseries(class_cTIC$cut0[cond], days[cond], type[cond], pch=pch, main="n-alkanes", endsig=T, xlab="incubation(days)", pt.bg=colscale)
timeseries(class_cTIC$cut1[cond], days[cond], type[cond], pch=pch, main="n-alkanes", endsig=T, xlab="incubation(days)", pt.bg=colscale)
@
\end{center}
