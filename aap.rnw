...
fit<-envfit(ord, data.frame(class_cTIC[,c("g","sy","ph")], rsim[,is.element(peaks$name, c("G0","G1", "G3:1c", "S0", "S1", "S3:1c"))]))
...
colnames(rsim)<-peaks$name  
fit<-envfit(ord, data.frame(class_cTIC[,c("g","sy","ph")]-initials.class_cTIC[,c("g","sy","ph")], rsim[,is.element(peaks$name, c("G0","G1", "G3:1c", "S0", "S1", "S3:1c"))]-initials.rsim[,is.element(peaks$name, c("G0","G1", "G3:1c", "S0", "S1", "S3:1c"))]))
plot(fit, p.max=0.05, col=c(rep("black",3), rep("darkgrey",10)), cex=0.5)
...
par(mfrow=c(2,2))
timeseries((class_cTIC$g+class_cTIC$sy)/(class_cTIC$g+class_cTIC$sy+orig_cTIC$Ph), days, type, endsig=T, pch=pch, col=colscale, main="Lignin/(Lignin+Phenolics")
timeseries(class_cTIC$g/(class_cTIC$g+class_cTIC$sy), days, type, endsig=T, pch=pch, col=colscale, main="Gaiacol/(Gaiacol+Syringol)")

timeseries( (class_cTIC$g+class_cTIC$sy)/(class_cTIC$g+class_cTIC$sy+orig_cTIC$Ph)- (initials.class_cTIC$g+initials.class_cTIC$sy)/(initials.class_cTIC$g+initials.class_cTIC$sy+initials.orig_cTIC$Ph), days, type, endsig=T, pch=pch, col=colscale, main="Lignin/(Lignin+Phenolics")
abline(h=0, lty=2)
timeseries(class_cTIC$g/(class_cTIC$g+class_cTIC$sy) - initials.class_cTIC$g/(initials.class_cTIC$g+initials.class_cTIC$sy), days, type, endsig=T, pch=pch, col=colscale, main="Gaiacol/(Gaiacol+Syringol)")
abline(h=0, lty=2)
