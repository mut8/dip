...
Metaproteome fungi:bateria ratios were highest (1:5 - 1:12) after 14 days and decrease during decomposistion (1:1.7 - 1:3 after 475 days). Differences between litter from different sites decrease during decomposition. Fungi are most dominant in SW, bacteria in AK. The fungi to bacteria ratio is negatively correlated to lignin decompostion during the first 6 month \ref{fig:f2b}.
